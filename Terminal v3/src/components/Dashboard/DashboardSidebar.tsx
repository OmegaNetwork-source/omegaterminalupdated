            ...
            <details className={styles.expandable}>
              ...
              <div className={styles.subActions}>
                ...
                <div className={styles.themeGrid}>
                  ...
                  <button className={`${styles.themeChip} ${styles.themeCosmic}`} onClick={() => handleSetTheme("cosmic")} title="Cosmic - Deep space nebula with stellar purple and blue gradients">
                    <span>Cosmic</span>
                  </button>
                  <button className={`${styles.themeChip} ${styles.themeGio}`} onClick={() => handleSetTheme("gio")} title="Gio - Vibrant pride theme with unicorn cursor and rainbow effects">
                    <span>🦄 Gio</span>
                  </button>
                </div>
              </div>
