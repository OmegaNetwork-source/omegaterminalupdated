import {H, PROJECTILE_ITERATIONS_PER_FRAME, PROJECTILE_ITERATION_PROGRESS, PROJECTILE_MAX_SOUND_FREQUENCY, PROJECTILE_MIN_SOUND_FREQUENCY, PROJECTILE_POWER_REDUCTION_FACTOR, PROJECTILE_WIND_REDUCTION_FACTOR, WEAPON_TYPES} from './engine/constants.js';
import {checkLineWith, drawLineVirtual} from './engine/gfx.js';
import {createParticles, isTank, isTankShield} from './engine/gameEngine.js';
import {deg2rad, parable} from './engine/math.js';
import {audio, createOsc} from './engine/sound.js';
import {isTerrain, landHeight} from './engine/terrain.js';
import {EXPLOSION_TYPES} from './engine/weapons.js';
